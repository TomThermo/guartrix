...
OpenAPI: [docs/openapi.yaml](docs/openapi.yaml) · Create keys under **Account → Access**. Contact profile / password change are session-only (`/api/account/profile`, `/password`) — see [Client API](docs/wiki/client-api.md).
...
| Password | Panel account password **or** SFTP app password (`gtap_…`) |
| Port | **2022** |
