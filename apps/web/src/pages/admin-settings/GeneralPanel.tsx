      ...
      <Col md={4}>
        <Form.Group>
          ...
          <Form.Control
            ...
            onChange={(e) => onDefaultMaxServersChange(Number(e.target.value) || 0)}
          />
        </Form.Group>
      </Col>
      <Col md={4}>
        <Form.Group>
          ...
          <Form.Control
            ...
            onChange={(e) => onDefaultMaxMemoryMbChange(Number(e.target.value) || 0)}
          />
        </Form.Group>
      </Col>
      <Col md={4}>
        <Form.Group>
          ...
          <Form.Control
            ...
            onChange={(e) => onDefaultMaxDatabasesChange(Number(e.target.value) || 0)}
          />
        </Form.Group>
      </Col>
      <Col xs={12}>
        <p className="small text-secondary mb-0">
          {t("adminSettings.defaultQuotasHelp")}{" "}
      ...
      <Col md={4}>
        <Form.Group>
          ...
          <Form.Control
            ...
            placeholder={
              cloudflareApiTokenSet ? t("adminSettings.secretSet") : t("adminSettings.secretEmpty")
            }
          />
        </Form.Group>
      </Col>
