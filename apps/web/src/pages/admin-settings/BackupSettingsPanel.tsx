      ...
      <Col md={6}>
        <Form.Group>
          ...
          <Form.Select
            ...
            onChange={(e) => onDefaultBackupKeepCountChange(Number(e.target.value))}
          >
          ...
          <Form.Text muted>
            {t("adminSettings.defaultBackupKeepCountHelp")}{" "}
            <Link to="/admin/servers">{t("adminSettings.perServerBackupLink")}</Link>
          </Form.Text>
        </Form.Group>
      </Col>
      <Col xs={12}>
