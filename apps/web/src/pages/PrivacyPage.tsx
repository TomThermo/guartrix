  ...
  return (
    <Container className="py-5" style={{ maxWidth: 720 }}>
      ...
      <p>
        ...
        enforce quotas, and keep the platform secure. We do not sell personal data.
      </p>
      <h2 className="h5 mt-4">Email</h2>
      <p>
        If SMTP is configured, password-reset messages are sent to the address on your
        account. Without SMTP, messages are written to an operator outbox on the host.
      </p>
      <h2 className="h5 mt-4">Retention</h2>
      <p>
        Account and server data remain until you or an admin delete them. Logs and mail
        outbox files may be rotated periodically. Deleted servers may linger briefly in
        backups until cleaned up.
      </p>
