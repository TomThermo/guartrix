    ...
    <>
      ...
      <ListGroup className="mb-3">
        {hits.length === 0 && !searching && (
          <ListGroup.Item className="text-secondary">{t("modpacks.noResults")}</ListGroup.Item>
        )}
        {hits.map((h) => {
          ...
          return (
            <ListGroup.Item
              ...
              onClick={clickable ? () => onSelectHit(h.projectId!) : undefined}
              ...
              <div className="d-flex gap-2 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <div className="small text-secondary">
                    {h.author ? `${t("addons.byAuthor", { author: h.author })} · ` : ""}
                    ...
                    <Stack direction="horizontal" gap={1} className="flex-wrap mt-1">
                      {h.categories.slice(0, 4).map((c) => (
                        <Badge
                          key={c}
                          bg="secondary"
                          className={source === "modrinth" ? "cursor-pointer" : undefined}
                          onClick={
                            source === "modrinth"
                              ? (e) => {
                                  e.stopPropagation();
