...
export function ApiExplorer() {
  ...
  const [panel, setPanel] = useState(
    () => prefs.panel || (typeof window !== "undefined" ? window.location.origin : "https://guartrix.com"),
  );
  ...
  const [endpointId, setEndpointId] = useState(
    () => prefs.endpointId || API_ENDPOINT_DEMOS[0]!.id,
  );
    ...
    <div className="api-ex">
      <div className="api-ex-intro">
        <p>
          ...
          <strong>run it live</strong> against this panel. Keys stay in{" "}
          <code>sessionStorage</code> on this browser only — never embedded in docs.
        </p>
      </div>
        ...
        <div className="api-ex-main">
          <header className="api-ex-endpoint-head">
            <div className="api-ex-endpoint-title">
              ...
              <code className="api-ex-path">{endpoint.path}{endpoint.query ? `?${endpoint.query}` : ""}</code>
            </div>
          ...
          {(endpoint.method === "POST" ||
            ...
            <label className="api-ex-field api-ex-body-field">
              ...
              />
              {!parsedBody.ok && (
                <span className="api-ex-error-inline">{parsedBody.error}</span>
              )}
            </label>
          )}
          ...
          <div className="api-ex-code-panel">
            ...
            <div className="api-ex-code-actions">
              <button type="button" className="btn btn-sm btn-outline-secondary" onClick={copySnippet}>
          ...
          <div className="api-ex-response">
            ...
            {run.status === "running" && <p className="api-ex-response-placeholder">Waiting for response…</p>}
