...
const AUTH = [
  ...
  },
  {
    ...
    prefix: "gt_",
    who: "Any user",
    create: "Account → Security → API keys",
  ...
  },
  {
    ...
    prefix: "gta_",
    who: "Machine (admin)",
    create: "Admin → Billing → Application API keys",
  ...
  return (
    <>
      ...
      <section className="docs-home-section">
        ...
        <p className="docs-home-section-lead">
          Choose the right credential for the job. HTTP automation uses Bearer{" "}
          <code>gt_</code> or <code>gta_</code>.
        </p>
