...
const AddonPanel = lazy(() =>
  import("../AddonPanel").then((m) => ({ default: m.AddonPanel })),
);
const BackupPanel = lazy(() =>
  import("../BackupPanel").then((m) => ({ default: m.BackupPanel })),
);
...
const FileManager = lazy(() =>
  import("../FileManager").then((m) => ({ default: m.FileManager })),
);
const LogPanel = lazy(() =>
  import("../LogPanel").then((m) => ({ default: m.LogPanel })),
);
...
const TasksPanel = lazy(() =>
  import("../TasksPanel").then((m) => ({ default: m.TasksPanel })),
);
      ...
      <Suspense fallback={<TabFallback />}>
        ...
        {tab === "allocations" && (
          <AllocationsPanel
            ...
            onNotice={onSetNotice}
            onPrimaryChanged={() => {
              void api.getServer(id).then(onSetServer).catch(() => undefined);
            }}
          />
        )}
        {tab === "subusers" && (
        ...
        {tab === "activity" && (
          <ActivityPanel serverId={id} onError={onSetError} />
        )}
