 ...
 */
function patchPropertiesText(raw: string, patches: Record<string, string>): string {
...
export async function readServerProperties(serverId: string): Promise<ServerProperties> {
