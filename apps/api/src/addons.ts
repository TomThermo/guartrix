...
const MODRINTH_TIMEOUT_MS = 12_000;
const MODRINTH_MAX_ATTEMPTS = 2;
...
function mapVersion(v: ModrinthVersion): AddonVersionInfo | null {
...
function pickVersion(
  ...
  return (
    (preferredVersionId
      ? versions.find((v) => v.versionId === preferredVersionId)
      : null) ??
...
function loadersFor(type: ServerType): string[] {
