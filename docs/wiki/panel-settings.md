...
| Mail | `MAIL_FROM`, SMTP host/port/TLS/user/password, **Test mail server**, **Mail templates** editor (Monaco HTML/text, Light/Dark preview, logo upload; overrides in `data/mail-templates.json`, logo in `data/branding/`) |
