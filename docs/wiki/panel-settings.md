...
| Mail | `MAIL_FROM`, SMTP host/port/TLS/user/password, **Test mail server**, **Mail templates** editor (HTML/text/preview with Light/Dark toggle; overrides in `data/mail-templates.json`) |
