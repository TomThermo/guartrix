...
Catalog highlights: settings patch, files content, addons install/remove, backups create, allocations, connect/SFTP meta, databases, app-password minting, Application provision/power/suspend.
