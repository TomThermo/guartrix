...
Pick an OS, install dependencies, download the installer, then run it.
...
**Do not** pipe the script into bash as your primary method. Download it first (`curl -Lo …`), then run it:
