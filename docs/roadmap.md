...
Last updated: **2026-08-10** · product **v1.4.21**
...
Alle sprints hieronder zijn **af**. Geen Sprint 10 gedefinieerd; zie Sprint 9 hierboven. Historical sprint checklists remain for archive only — current product version is **v1.4.21** (see `VERSION` / changelog).
