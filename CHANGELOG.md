...
- Docs audit: OpenAPI/roadmap version sync; development (coverage + NL lazy-load); billing/license/daemon/backup internals; README ops smoke + preseed; in-app wiki mirror for security/install-nodes/operations
